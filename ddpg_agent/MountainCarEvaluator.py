...
def evaluate_hyperparams(params):
    ...
    print("Evaluating MountainCarContinuous with params:",params)
    eps, ou_theta = params
    
    env = gym.make('MountainCarContinuous-v0')

    agent = DDPG(env, train_during_episode=True, ou_mu=0, ou_theta=ou_theta, ou_sigma=.25, 
    ...
    agent.train_n_episodes(30, eps=eps, eps_decay=1/50, action_repeat=5, run_tests=True, )
